...
test("bilingual README release tags, portable assets, bundles, and checksums are version-bound", async () => {
  const scenarios = [
    ["README.md", "releases/tag/v0.1.0-beta.11", "releases/tag/v0.1.0-beta.10"],
    ["README.zh-CN.md", "Useful-0.1.0-beta.11-windows-x64-portable-lite.zip", "Useful-0.1.0-beta.10-windows-x64-portable-lite.zip"],
    ["README.md", "Useful-0.1.0-beta.11-windows-x64-setup-lite.exe", "Useful-0.1.0-beta.10-windows-x64-setup-lite.exe"],
  ];
