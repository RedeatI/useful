...
export const AGENT_DOC_COMMANDS = Object.freeze([
  ...
  "useful agent export --target mcp-servers-json --launcher \"<ABS_USEFUL_MCP_LAUNCHER>\" --json",
  "useful agent probe --json",
  "useful agent verify --target mcp-servers-json --launcher \"<ABS_FIXED_USEFUL_MCP_LAUNCHER>\" --json",
  "useful agent verify-all --launcher \"<ABS_FIXED_USEFUL_MCP_LAUNCHER>\" --json",
  "useful computer-use probe --json",
...
export function agentContractData(templates) {
  return {
    ...
    commands: {
      ...
      agentExport: "useful agent export --target <codex|claude-code|claude-desktop|mcp-servers-json> --launcher <host-native-absolute-path> [--scope user|project] [--project-dir <host-native-absolute-directory>] [--env NAME=VALUE] --json",
      agentProbe: "useful agent probe --json",
      computerUseProbe: "useful computer-use probe --json",
      agentVerify: "useful agent verify --target <codex|claude-code|claude-desktop|mcp-servers-json> --launcher <current-installation-fixed-useful-mcp-entry> [--scope user|project] [--project-dir <host-native-absolute-directory>] [--env NO_COLOR=1] [--env USEFUL_LOG_LEVEL=<error|warn|info>] --json",
      agentVerifyAll: "useful agent verify-all --launcher <current-installation-fixed-useful-mcp-entry> --json",
